...
const s = {
  ...
  breadcrumb: { fontSize: 11, fontWeight: 900, color: "var(--on-surface-variant)", letterSpacing: "0.15em", marginBottom: 8, fontFamily: "Manrope", textTransform: "uppercase" },
  pageTitle: { fontSize: 36, fontWeight: 800, color: "var(--on-surface)", letterSpacing: "-0.02em", marginBottom: 8, fontFamily: "Manrope" },
  pageSub: { fontSize: 16, color: "var(--on-surface-variant)", maxWidth: 640, lineHeight: 1.6 },
  ...
  th: { padding: "18px 24px", fontSize: 11, fontWeight: 800, color: "var(--on-surface-variant)", textAlign: "left", letterSpacing: "0.1em", background: "var(--surface-container-low)", borderBottom: "1px solid var(--outline)", textTransform: "uppercase" },
  tr: { transition: "background 100ms" },
  taskCell: { padding: "20px 24px", display: "flex", alignItems: "center", gap: 12 },
  statusDot: { width: 8, height: 8, borderRadius: "50%", flexShrink: 0 },
  taskName: { fontSize: 15, fontWeight: 600, color: "var(--on-surface)" },
  tdTime: { fontSize: 13, color: "var(--on-surface-variant)", padding: "0 24px", whiteSpace: "nowrap" },
